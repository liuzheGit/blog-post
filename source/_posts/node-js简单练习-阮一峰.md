---
title: node.js简单练习-阮一峰
date: 2018-10-23 16:03:17
tags: [JavaScript, nodejs, eslint]
categories: Front-End
---

一直想自己写接口玩玩,今天公司不忙就在网上找找有没有合适的练手的demo,发现阮一峰老师有写过此类教程.
github地址: [ruanyf/jstrining](https://github.com/ruanyf/jstraining/tree/master/demos#simple-app)
这个项目是一个很全面的教程,我此次只练习的一部分,大家喜欢可以都试试.
...
其实这次我的目的就是来找找写接口的demo,其中的npm库`json-server`就符合我的目的,配置一份本地测试数据库的模拟JSON文件,以后就不用自己写在页面中的模拟假数据了.
